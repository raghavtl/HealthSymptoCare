...
const HomePage = () => {
  ...
  return (
    <div>
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-r from-primary to-purple-600 text-white py-20 rounded-lg mb-12 transition-colors">
      ...
      <section className="mb-12 bg-gray-50 py-12 rounded-lg">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-8">Why Choose Health Sympto Care?</h2>
      ...
      <section className="bg-secondary text-white py-12 rounded-lg text-center">
        ...
        <p className="text-xl mb-6">Take control of your health with Health Sympto Care</p>
        {currentUser ? (
          <div className="flex flex-wrap justify-center gap-4">
